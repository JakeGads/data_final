...
png(paste("_init_filtered/", "grid", ".png", sep=""))
plot_grid(
...
png(paste("_init_filtered/", "grid_smooth", ".png", sep=""))
plot_grid(
    get_scatter(data_scatter, cat_val[2]), get_scatter(data_scatter, cat_val[3]),
    get_scatter(data_scatter, cat_val[4]), get_scatter(data_scatter, cat_val[5]),
    nrow = 2, ncol = 2
...
png(paste("_init_hist/", "grid", ".png", sep=""))
plot_grid(
...
png(paste("_init_hist/", "grid_rmoutliers", ".png", sep=""))
plot_grid(
...
for(i in 2:length(cat_val)){
    png(paste("_bubble/", cat_val[i], ".png", sep=""))
    print(get_bubble(data_bubble, cat_val[i]))
    dev.off()
}

png(paste("_bubble/", "grid", ".png", sep=""))
plot_grid(
